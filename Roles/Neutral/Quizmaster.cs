    ...
    private void DoQuestion()
    {
        ...
        if (MarkedPlayer != byte.MaxValue)
        {
            ...
            [
                ...
                new SetAnswersQuestion { Stage = 5, Question = "TOHEPartners", Answer = "Modded Among Us Lobbies & Purple Among Us", PossibleAnswers = { "Innersloth", "Modded Among Us Lobbies", "Purple Among Us", "Modded Among Us Lobbies & Purple Among Us", "Steam", "Twitter", "Town Of Us: Reactivated", "Moe Corporation", "Digital Bandidos" }, QuizmasterQuestionType = QuizmasterQuestionType.TOHEPartners },
                new SetAnswersQuestion { Stage = 5, Question = "MargEdition", Answer = "Marg", PossibleAnswers = { "Furo", "Drakos", "Moe", "Marg", "Multiple People", "TommyXL", "Niko", "Pyro", "KARPED1EM", "Ryuk", "Laikrai" }, QuizmasterQuestionType = QuizmasterQuestionType.MargEdition },
                ...
                new SetAnswersQuestion { Stage = 5, Question = "HeartBreaker", Answer = "Rizzler", PossibleAnswers = { "Heart Breaker", "Rizzler", "Seducer", "Hopeless Romantic", "Love Stealer", "Lovestruck" }, QuizmasterQuestionType = QuizmasterQuestionType.HeartBreaker },
            ];
